...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/338df77f-6003-4b83-a015-6c3835fa4f6d-vless"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="338df77f-6003-4b83-a015-6c3835fa4f6d"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="338df77f-6003-4b83-a015-6c3835fa4f6d-vmess"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="338df77f-6003-4b83-a015-6c3835fa4f6d"
fi
echo ${Vmess_UUID}
